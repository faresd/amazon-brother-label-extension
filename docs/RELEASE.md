...
6. When `CWS_UPLOAD_ENABLED=true`, the production Store workflow authenticates through keyless Google Workload Identity Federation, uploads the Store ZIP with Chrome Web Store API v2, and submits it when `CWS_SUBMIT_FOR_REVIEW=true`.
